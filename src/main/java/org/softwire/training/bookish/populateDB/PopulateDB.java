...
public class PopulateDB {
    public static void main(String[] args) throws SQLException {
        ...
        jdbi.useHandle(handle -> {
            ...
            handle.execute("ALTER TABLE BookAuthor ADD CONSTRAINT fk_Book_BookId FOREIGN KEY(Book) REFERENCES Book (BookId) ON DELETE CASCADE;");
            handle.execute("ALTER TABLE Borrows ADD CONSTRAINT fk_Copies_CopyId FOREIGN KEY(BorrowedCopyId) REFERENCES Copies (CopyId) ON DELETE CASCADE;");
            handle.execute("ALTER TABLE Copies ADD CONSTRAINT fk_Copies_BookId FOREIGN KEY(BookId) REFERENCES Book (BookId) ON DELETE CASCADE;");
            handle.execute("ALTER TABLE BookAuthor ADD CONSTRAINT fk_Authors_AuthorId FOREIGN KEY(Author) REFERENCES Authors (AuthorId) ON DELETE CASCADE;");
            handle.execute("ALTER TABLE Librarians ADD CONSTRAINT fk_Librarians_Username FOREIGN KEY(Username) REFERENCES Users (Username) ON DELETE CASCADE;");
            handle.execute("ALTER TABLE Borrows ADD CONSTRAINT fk_Borrows_Username FOREIGN KEY(Username) REFERENCES Users (Username) ON DELETE CASCADE;");
