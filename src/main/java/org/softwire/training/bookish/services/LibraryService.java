...
public class LibraryService extends DatabaseService {
    ...
    public void addBook(Book book) {
            jdbi.useHandle(handle ->
                    handle.createUpdate("INSERT INTO book (title, ISBN, published_date, publisher, genre, number_of_copies, author_id, book_cover_url) " +
                                    "VALUES (:title, :ISBN, :published_date, :publisher, :genre, :number_of_copies, :author_id, :book_cover_url)")
                            ...
                            .bind("book_cover_url", book.getBookCoverUrl())
                            .execute()
            );
    }
